...
| Field | Value |
|-------|-------|
| **Evidence** | `docs/evidence/admin-governance-final-acceptance/2026-07-08T12-36-30-admin-gov-final-acceptance-1/` |
| **Verdict** | **ADMIN_GOV_FINAL_ACCEPTANCE_BLOCKED_FUNCTIONAL_DEFECT** |
| **Stack** | DOWN |
| **Playwright** | SKIPPED_STACK_DOWN |
| **Regressions** | FAIL |
| **Blocker issues** | 2 |
